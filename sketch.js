...
function draw() {
  ...
  for (var i = 0; i < playerArrows.length; i++) {
    if (playerArrows[i] !== undefined) {
      ...
      var board1collisition = Matter.SAT.collides(board1.body,playerArrows[i].body);
      var board2collisition = Matter.SAT.collides(board2.body,playerArrows[i].body);

      if(board1collisition.collided || board2collisition.collided )
      {
